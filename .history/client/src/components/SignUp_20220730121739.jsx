  ...
  return (
    <Card className='d-flex justify-content-center' style={{ width: '25rem' }}>
      ...
      <Form onSubmit={handleSubmit}> 
          ...
          <Button onClick={handleSubmit} variant="warning" className='border border-blue-500 bg-yellow-600 hover:bg-blue-500 w-full p-4 my-2 text-white'>Sign up</Button>
      </Form>
